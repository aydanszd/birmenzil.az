                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-10">
                    <div className="hidden md:flex items-center gap-5">
                        {topLinks.map(({ label, icon: Icon }) => (
                            <Link key={label} href="#" className="flex items-center gap-1 text-sm text-gray-600 transition-colors">
                                <Icon size={14} />
                                {label}
                            </Link>
                        ))}
                    ...
                    <div className="flex items-center gap-2 ml-auto">
                        <button className="flex items-center gap-2" aria-label="Xəritə">
                            <Map size={18} />
                        </button>
                        <button className="flex items-center gap-2" aria-label="Müqayisə">
                            <Scale size={18} />
                        </button>
                        <button className="flex items-center gap-2" aria-label="Seçilmişlər">
                            <Heart size={18} />
                        </button>
                        <button className="flex items-center gap-2" aria-label="Əlavə et">
                            <CreditCard size={18} />
                        </button>
                        <Link
                            href="#"
